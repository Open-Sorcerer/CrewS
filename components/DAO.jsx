                    ...
                    <div className='w-full h-full flex flex-col justify-start items-start flex-wrap gap-3' key={proposal.id}>
                        ...
                        <div className='w-full h-full flex flex-col justify-evenly items-center bg-black border-2 border-secondary/30 rounded-md p-3 gap-2'>
                            <div className='w-full h-full grid grid-cols-4'>
                                <h1 className='flex justify-start px-2 items-center col-span-2'>{proposal.title}</h1>
                                <h1 className='flex justify-start px-2 items-center col-span-1'>{proposal.status}</h1>
                                <h1 className='flex justify-start px-2 items-center col-span-1'>{proposal.creator}</h1>
                            </div>
                            <div className='w-full h-full grid grid-cols-4'>
                                <div className='flex justify-start px-2 items-center col-span-1 gap-2'>
                                    <FontAwesomeIcon icon={faUpLong} className='h-5 w-5 text-gray-300' />
                                    <h1>{proposal.votes}</h1>
                                </div>
                                <h1 className='flex justify-start px-2 items-center col-span-3'>{proposal.description}</h1>
                            </div>
                        </div>
                    </div>
                )
